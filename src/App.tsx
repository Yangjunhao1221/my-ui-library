...
function App() {
    const searchListFun = (str: string, data: Array<any>, renderHintList: (arr: Array<any>) => Array<any>): Array<any> => {
        alert(str)
        return []
    }
    const [arrData, setArrData] = useState<Array<listProps>>([
    ...
    return (
        <div className="App">
            <header className="App-header">
                ...
                &nbsp; <Input size={'sm'} searchData={arrData} icon={'calendar-days'}
